...
const PopularTrainingCard = ({ imageSrc, imageSrcSet, price, title, hashtags, calories, rating, description }: {
  imageSrc: string;
  imageSrcSet: string;
  price: string;
  title: string;
...
// Компонент для одной карточки пользователя
const LookingForCompanyCard = ({ imageSrc, imageSrcSet, name, location, hashtag }: {
  imageSrc: string;
  imageSrcSet: string;
  name: string;
  location: string;
  ...
  <li className="look-for-company__item">
    <div className="thumbnail-user thumbnail-user--role-user thumbnail-user--dark">
      <div className="thumbnail-user__image">
        <picture>
          <source type="image/webp" srcSet={imageSrcSet} />
          <img src={imageSrc} srcSet={imageSrcSet} width="82" height="82" alt="" />
        </picture>
      </div>
...
export default function HomePage() {
  ...
  const handleSliderControlClick = (e: MouseEvent) => {
    e.preventDefault();
    console.log('Клик по кнопке управления слайдером');
  };
            ...
            <div className="special-for-you__wrapper">
              <div className="special-for-you__title-wrapper">
                ...
                <div className="special-for-you__controls">
                  <button className="btn-icon special-for-you__control" type="button" aria-label="previous" onClick={handleSliderControlClick}>
                    <svg width="16" height="14" aria-hidden="true">
                      <use xlinkHref="#arrow-left"></use>
                    </svg>
                  </button>
                  <button className="btn-icon special-for-you__control" type="button" aria-label="next" onClick={handleSliderControlClick}>
                    <svg width="16" height="14" aria-hidden="true">
          ...
          <div className="container">
            <div className="popular-trainings__wrapper">
              <div className="popular-trainings__title-wrapper">
                ...
                <button className="btn-flat popular-trainings__button" type="button" onClick={handleViewAllClick}>
                ...
                <div className="popular-trainings__controls">
                  <button className="btn-icon popular-trainings__control" type="button" aria-label="previous" onClick={handleSliderControlClick}>
                    <svg width="16" height="14" aria-hidden="true">
                      <use xlinkHref="#arrow-left"></use>
                    </svg>
                  </button>
                  <button className="btn-icon popular-trainings__control" type="button" aria-label="next" onClick={handleSliderControlClick}>
                    <svg width="16" height="14" aria-hidden="true">
                      <use xlinkHref="#arrow-right"></use>
                    </svg>
                  </button>
              ...
              <ul className="popular-trainings__list">
                ...
                />
                <PopularTrainingCard
                  imageSrc="img/content/thumbnails/training-11.jpg"
                  imageSrcSet="img/content/thumbnails/training-11.webp, img/content/thumbnails/training-11@2x.webp 2x"
                  price="2200"
                  title="devil's cindy"
                  hashtags={['#кроссфит']}
                  calories="#950ккал"
                ...
                />
                <PopularTrainingCard
                  imageSrc="img/content/thumbnails/training-09.jpg"
                  imageSrcSet="img/content/thumbnails/training-09.webp, img/content/thumbnails/training-09@2x.webp 2x"
                  price="1800"
          ...
          <div className="container">
            <div className="look-for-company__wrapper">
              <div className="look-for-company__title-wrapper">
                ...
                <button className="btn-flat btn-flat--light look-for-company__button" type="button" onClick={handleViewAllClick}>
                  <span>Смотреть все</span>
                  <svg width="14" height="10" aria-hidden="true">
                    <use xlinkHref="#arrow-right"></use>
                  </svg>
                ...
                <div className="look-for-company__controls">
                  <button className="btn-icon btn-icon--outlined look-for-company__control" type="button" aria-label="previous" onClick={handleSliderControlClick}>
                    <svg width="16" height="14" aria-hidden="true">
                      <use xlinkHref="#arrow-left"></use>
                    </svg>
                  </button>
                  <button className="btn-icon btn-icon--outlined look-for-company__control" type="button" aria-label="next" onClick={handleSliderControlClick}>
                    <svg width="16" height="14" aria-hidden="true">
                      <use xlinkHref="#arrow-right"></use>
                    </svg>
                  </button>
              ...
              <ul className="look-for-company__list">
                <LookingForCompanyCard
                  imageSrc="img/content/thumbnails/user-04.jpg"
                  imageSrcSet="img/content/thumbnails/user-04.webp, img/content/thumbnails/user-04@2x.webp 2x"
                  name="Диана"
                  location="Невский проспект"
                  hashtag="#пилатес"
                />
                <LookingForCompanyCard
                  imageSrc="img/content/thumbnails/user-05.jpg"
                  imageSrcSet="img/content/thumbnails/user-05.webp, img/content/thumbnails/user-05@2x.webp 2x"
                  name="Константин"
                  location="Комендантский проспект"
                  hashtag="#силовые"
                />
                {/* Здесь должны быть остальные карточки */}
              </ul>
            </div>
          </div>
        </section>
