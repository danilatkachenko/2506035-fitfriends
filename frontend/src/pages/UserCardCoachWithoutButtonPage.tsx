...
export default function UserCardCoachWithoutButtonPage() {
          ...
          <div className="container">
            <div className="inner-page__wrapper">
              ...
              <div className="inner-page__content">
                <section className="user-card-coach-2">
                  <h1 className="visually-hidden">Карточка пользователя роль тренер</h1>
                  <div className="user-card-coach-2__wrapper">
                    <div className="user-card-coach-2__card">
                      <div className="user-card-coach-2__content">
                        <div className="user-card-coach-2__head">
                          <h2 className="user-card-coach-2__title">Валерия</h2>
                        </div>
                        <div className="user-card-coach-2__label">
                          <a href="/markup/popup-user-map.html">
                        ...
                        <div className="user-card-coach-2__status-container">
                          <div className="user-card-coach-2__status user-card-coach-2__status--tag">
                            <svg className="user-card-coach-2__icon-cup" width="12" height="13" aria-hidden="true">
                        ...
                        <div className="user-card-coach-2__text">
                          <p>
                        ...
                        <ul className="user-card-coach-2__hashtag-list">
                          <li className="user-card-coach-2__hashtag-item">
                        ...
                        <button className="btn btn--outlined user-card-coach-2__btn" type="button">Удалить из друзей</button>
                      </div>
                      <div className="user-card-coach-2__gallary">
                        <ul className="user-card-coach-2__gallary-list">
                          <li className="user-card-coach-2__gallary-item">
                    ...
                    <div className="user-card-coach-2__training">
                      <div className="user-card-coach-2__training-head">
                        <h2 className="user-card-coach-2__training-title">Тренировки</h2>
                        <div className="user-card-coach-2__training-bts">
                          <button className="btn-icon user-card-coach-2__training-btn" type="button" aria-label="back">
                            <svg width="14" height="10" aria-hidden="true">
                              <use xlinkHref="#arrow-left"></use>
                            </svg>
                          </button>
                          <button className="btn-icon user-card-coach-2__training-btn" type="button" aria-label="next">
                            <svg width="14" height="10" aria-hidden="true">
                      ...
                      <ul className="user-card-coach-2__training-list">
                        <li className="user-card-coach-2__training-item">
                      ...
                      <form className="user-card-coach-2__training-form">
                        <div className="user-card-coach-2__training-check">
