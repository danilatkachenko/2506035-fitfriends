...
export default function PersonalAccountUserPage() {
          ...
          <div className="container">
            <div className="inner-page__wrapper">
              ...
              <section className="user-info">
                ...
                <form className="user-info__form" onSubmit={handleFormSubmit}>
                  ...
                  <div className="user-info__section">
                    ...
                    <div className="custom-input custom-input--readonly user-info__input">
                      <label>
                        ...
                        <span className="custom-input__wrapper">
                          <input type="text" name="name" defaultValue="Валерия" disabled />
                        </span>
                      </label>
                    </div>
                    <div className="custom-textarea custom-textarea--readonly user-info__textarea">
                      <label>
                        ...
                        <textarea name="description" placeholder=" " disabled defaultValue="Персональный тренер и инструктор групповых программ с опытом  более 4х лет. Специализация: коррекция фигуры и осанки, снижение веса, восстановление после травм, пилатес."></textarea>
                      </label>
                    </div>
                  </div>
