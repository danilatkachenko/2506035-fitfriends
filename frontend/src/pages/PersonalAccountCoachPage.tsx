...
export default function PersonalAccountCoachPage() {
          ...
          <div className="container">
            <div className="inner-page__wrapper">
              ...
              <section className="user-info-edit">
                ...
                <form className="user-info-edit__form" onSubmit={handleFormSubmit}>
                  ...
                  <div className="user-info-edit__section">
                    ...
                    <div className="custom-textarea user-info-edit__textarea">
                      <label>
                        ...
                        <textarea name="description" placeholder=" " defaultValue="Персональный тренер и инструктор групповых программ с опытом  более 4х лет. Специализация: коррекция фигуры и осанки, снижение веса, восстановление после травм, пилатес."></textarea>
                      </label>
                    </div>
                  </div>
                        ...
                        <div className="certificate-card">
                          <div className="certificate-card__image">
                            <picture>
                              ...
                              <img src="/img/content/certificates-and-diplomas/certificate-5.jpg" srcSet="/img/content/certificates-and-diplomas/certificate-5@2x.jpg 2x" width="294" height="360" alt="Сертификат фитнес аэробики" />
                            </picture>
                          </div>
                          <div className="certificate-card__buttons">
                            <button className="btn-flat btn-flat--underlined certificate-card__button certificate-card__button--edit" type="button">
                        ...
                        <div className="certificate-card">
                          <div className="certificate-card__image">
                            <picture>
                              ...
                              <img src="/img/content/certificates-and-diplomas/certificate-6.jpg" srcSet="/img/content/certificates-and-diplomas/certificate-6@2x.jpg 2x" width="294" height="360" alt="Сертификат фитнес аэробики" />
                            </picture>
                          </div>
                          <div className="certificate-card__buttons">
                            <button className="btn-flat btn-flat--underlined certificate-card__button certificate-card__button--edit" type="button">
